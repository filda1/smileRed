...
namespace smileRed.Backend.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProductId,CategoryId,Name,Description,Price,Image,Stock,IsActive,Remarks")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProductId,CategoryId,Name,Description,Price,Image,Stock,IsActive,Remarks")] Product product)
        {
